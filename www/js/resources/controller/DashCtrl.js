angular.module('starter.dashctrl', ['ionic-datepicker'])
.controller('DashCtrl', function($scope, $state, $location, ReportService,
daterangepicker, $cordovaCamera, $base64, $ionicPopup, $http, $ionicModal) {
